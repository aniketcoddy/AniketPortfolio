  ...
  return (
    <div className="h-full flex justify-center px-4 lg:flex-row  sm:px-8 md:px-12 lg:px-20 xl:px-48 flex-col">
      ...
      <div className="h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-5 items-center justify-center">
        ...
        <p className="md:text-base ">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Saepe dolor, sequi reprehenderit, maiores atque 
        ...
        <div className="flex gap-3 w-full "> 
          <button className="p-2 rounded ring-1 bg-black text-white ring-black">View My Work</button>
