  ...
  return (
    <motion.div className="h-full " initial={{y:"-200vh"}} animate={{y:"0vh"}} transition={{duration:"1"}}>
      <div className="h-full flex justify-center px-4 lg:flex-row  sm:px-8 md:px-12 lg:px-20 xl:px-48 flex-col">
        ...
        {/* text container */}
        <div className="h-1/3 md:h-1/2 lg:h-full lg:w-1/2 flex flex-col gap-3 2xl:gap-8 md:gap-5 items-center justify-center">
          <h1 className="text-2xl md:text-5xl 2xl:text-7xl font-bold ">FrontEnd Developer</h1>
